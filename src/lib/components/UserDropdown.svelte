<script>
  ...
  import { userDisplayInfo, clearAuth } from '$lib/stores/auth.js';
  import { authApi } from '$lib/services/api-client.js';
  
  let dropdownOpen = false;
  let dropdownElement;
  
  // Use the reactive store for user display info
  ...
  async function handleSignOut() {
    ...
    // Clear authentication data from localStorage and stores
    clearAuth();
    ...
    >
      <div class="user-avatar">
        {#if displayInfo.avatarUrl}
          <img src={displayInfo.avatarUrl} alt={displayInfo.displayName} class="avatar-image" />
        {:else}
          <span class="avatar-initials">{displayInfo.initials}</span>
        {/if}
      </div>
      <span class="user-name">{displayInfo.displayName}</span>
      <svg
    ...
    {#if dropdownOpen}
      <div class="dropdown-menu">
        <div class="dropdown-header">
          <div class="user-info">
            <div class="user-name-large">{displayInfo.displayName}</div>
            <div class="user-email">{displayInfo.email || ''}</div>
          </div>
        </div>
